package game.listeners.tutorial
{
	...
	public class TutorialScreenListener15 extends ScreenListener
	{
		public function TutorialScreenListener15(screen:Screen, videoType:String = Video.TYPE_SONG)
		{
			super(screen, videoType);
			Main.appendMessage("Tutorial Screen Listener 15");
		}
		...
		private function goToNextScreen(event:ButtonEvent):void
		{
			...
			var tutorialScreen16:Screen = new Screen(Images.getInstance().image13, Sounds.getInstance().sound13);
			tutorialScreen16.addEventListener(Event.ADDED, new TutorialScreenListener16(tutorialScreen16, this.videoType).loaded);
			Main.instance.replaceScreen(tutorialScreen16);
		}
	}
}