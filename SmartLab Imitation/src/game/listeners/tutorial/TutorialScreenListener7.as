package game.listeners.tutorial
{
	...
	public class TutorialScreenListener7 extends ScreenListener
	{
		public function TutorialScreenListener7(screen:Screen, videoType:String = Video.TYPE_SONG)
		{
			super(screen, videoType);
			Main.appendMessage("Tutorial Screen Listener 7");
		}
		...
		{
			var tutorialScreen8:Screen = new Screen(Images.getInstance().image7, Sounds.getInstance().sound7);
			tutorialScreen8.addEventListener(Event.ADDED, new TutorialScreenListener8(tutorialScreen8, this.videoType).loaded);
			Main.instance.replaceScreen(tutorialScreen8);
		}
	}
}