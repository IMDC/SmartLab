package game.listeners.tutorial
{
	...
	public class TutorialScreenListener14 extends ScreenListener
	{
		public function TutorialScreenListener14(screen:Screen, videoType:String = Video.TYPE_SONG)
		{
			super(screen, videoType);
			Main.appendMessage("Tutorial Screen Listener 14");
		}
		...
		private function goToNextScreen(event:ButtonEvent):void
		{
			...
			var tutorialScreen15:Screen = new Screen(Images.getInstance().image12, Sounds.getInstance().sound12);
			tutorialScreen15.addEventListener(Event.ADDED, new TutorialScreenListener15(tutorialScreen15, this.videoType).loaded);
			Main.instance.replaceScreen(tutorialScreen15);
		}
	}
}