package game.listeners.tutorial
{
	...
	public class TutorialScreenListener6 extends VideoPlaybackScreenListener
	{
		public function TutorialScreenListener6(screen:Screen, videoType:String = Video.TYPE_SONG)
		{
			super(screen);
			this.videoType = videoType;
			Main.appendMessage("Tutorial Screen Listener 6");
		...
		override public function videoEnded(event:Event):void
		{
			...
			var tutorialScreen7:Screen = new Screen(Images.getInstance().image6, Sounds.getInstance().sound6);
			tutorialScreen7.addEventListener(Event.ADDED, new TutorialScreenListener7(tutorialScreen7, this.videoType).loaded);
			Main.instance.replaceScreen(tutorialScreen7);
		}
